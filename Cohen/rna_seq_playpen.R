...
#align("reference_index", "D7ON.fastq", nthreads=5)
#align("reference_index", "D7OFF.fastq", nthreads=5)
#align("reference_index", "D11ON.fastq", nthreads=5)
#align("reference_index", "D11OFF.fastq", nthreads=5)
#align("reference_index", "D15ON.fastq", nthreads=5)
#align("reference_index", "D15OFF.fastq", nthreads=5)
