...
#Reading in CpGs that are permitted due to not being associated with T-cell differentiation.
permitted_cpgs <- read.csv("ClockConstruction/nodiff_cpgs.csv")$x
...
# magnaye2022450k_cpgs <- magnaye2022450k_cpgs[rownames(magnaye2022450k_cpgs) %in% permitted_cpgs,]
# 
...
# magnaye2022EPIC_cpgs <- magnaye2022EPIC_cpgs[rownames(magnaye2022EPIC_cpgs) %in% permitted_cpgs,]
# 
